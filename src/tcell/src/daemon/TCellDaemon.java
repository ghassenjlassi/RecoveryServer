...
import messages.ServerGetUserData;
import tools.Tools;
...
public class TCellDaemon{
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			List<EncryptContact> EncryptedUsers = new ArrayList<EncryptContact>();
			...
			if (!users.isEmpty()){
				...
				for (User contact : users) {
					...
					EncryptContact EncryptedUser = new EncryptContact(strEncryptedUserGID, strEncrTCellIP, strEncrPort, strEncrPubKey);
			...
			String pubkey = myInfo.getMyPubKey();
			//MyInfo user = new MyInfo(, null);
		//	System.out.println("my info + " +user.toString()+"\n contact :"+EncryptedUsers.toString());
			ServerGetUserData.sendUserInfo(userGID, TcellIP, listenPort, pubkey , EncryptedUsers);
